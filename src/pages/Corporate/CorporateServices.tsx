...
const servicesData = [
  {
    ...
    tagline: `Mueen Human Resources Company takes the hard work out of the job search by using their knowledge and resources to connect candidates and employers.`,
  ...
  },
  {
    ...
    tagline: `Mueen facilitates the recruitment of permanents hires on your behalf as a valuable supplement to your internal staffing teams.`,
    description: `Recognizing that organizations often face fluctuations in staffing needs, Mueen steps in to provide the specialized expertise and resources you require. This collaborative approach ensures that our clients' internal teams can continue to manage their respective HR ...`,
  ...
  },
  {
    ...
    tagline: `Mueen provides a range of strategies and services aimed at managing and optimizing the human resources within your organization.`,
